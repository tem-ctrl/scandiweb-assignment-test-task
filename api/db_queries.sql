...
USE scandiweb_test_db;

-- Create tables for different product types
CREATE TABLE IF NOT EXISTS scandiweb_test_db.dvd(
...
CREATE TABLE IF NOT EXISTS scandiweb_test_db.book(
  sku VARCHAR(50) NOT NULL PRIMARY KEY,
  name VARCHAR(50) NOT NULL,
  price FLOAT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS scandiweb_test_db.furniture(
  sku VARCHAR(50) NOT NULL PRIMARY KEY,
  name VARCHAR(50) NOT NULL,
  price FLOAT NOT NULL DEFAULT 1,
